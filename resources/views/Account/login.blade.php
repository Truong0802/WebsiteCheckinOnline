                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-7 col-lg-8 hidden-xs hidden-sm">
                        ...
                        <div class="hero">
                            ...
                            <img alt="" class="pull-right display-image" src="<?php echo asset('/img/iphoneview.png')?>" style="width:210px">
                        </div>
                        <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-5 col-lg-4">
                        <div class="well no-padding">
                            <form action="/account-login" method="post" class="smart-form client-form ng-dirty ng-touched ng-valid" novalidate="">
